...
public: 
	...
	void DrawSprite(std::string texturePath, Vector2 position, bool flipX, Vector2 anchor, RenderPosition renderPos = RenderPosition::WORLD);
	void DrawSpriteCropped(std::string texturePath, Rect textureCrop, Vector2 position, bool flipX, Vector2 anchor, RenderPosition renderPos = RenderPosition::WORLD);
